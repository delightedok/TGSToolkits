...
static int tester_cocktail_shaker_sorts_on_compare(void * obj1, void * obj2)
{
    int * p1 = (int *)obj1;
    int * p2 = (int *)obj2;
...
static int tester_cocktail_shaker_sorts_on_exchange(void * obj1, void * obj2)
{
...
static void * tester_cocktail_shaker_sorts_on_duplicate(void * obj)
{
    return obj;
}

static void tester_cocktail_shaker_sorts_on_free(void * obj)
{
}
...
int main(int argc, char * args[])
{
    ...
    SortVTable vTable;
    vTable.onCompare = tester_cocktail_shaker_sorts_on_compare;
    vTable.onExchange = tester_cocktail_shaker_sorts_on_exchange;
    vTable.onDuplicate = tester_cocktail_shaker_sorts_on_duplicate;
    vTable.onFree = tester_cocktail_shaker_sorts_on_free;
    SortCocktailShakerObject obj(vTable);
